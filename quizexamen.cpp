    ...
    QuizExamen::QuizExamen(Quiz *quiz, QWidget *parent)
        : QDialog(parent), ui(new Ui::QuizExamen), quiz(quiz), currentQuestionIndex(0)
    {
        ui->setupUi(this);
        ...
        connect(ui->SubmitButton, &QPushButton::clicked, this, [this, questions]() {
            ...
            QMessageBox::information(this, "Quiz Result",
